...
export const mockHotels: Hotel[] = [
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        price: 10500,
        capacity: 2,
        description: "Access to the executive lounge.",
        available: true,
        amenities: ["WiFi", "Lounge Access", "Breakfast"],
      ...
      },
      {
        ...
        available: true,
        amenities: ["Living Room", "Bathtub", "Skyline View"],
        imageUrl: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=800"
      },
      {
        id: "h1_4",
        type: "Family Premium Room",
        price: 14000,
        capacity: 4,
        description: "Two interconnected rooms for families.",
        available: true,
        amenities: ["Interconnected", "Kids Kit", "WiFi"],
  ...
  },
  {
    ...
    imageUrl: "https://aistudio.google.com/_/upload/6f40da42-c618-4907-a0fb-845407bd4908/attachment/1776420066.818787000/blobstore/prod/makersuite/spanner_managed/global::000054e2ea70026d:0000015f:2:000054e2ea70026d:0000000000000001::f153417887bc02de:000001efdd2018bc:00064fa50709f11f",
    ...
    rooms: [
      {
        ...
        price: 6500,
        capacity: 2,
        description: "Elegant room with modern art.",
        available: true,
        amenities: ["WiFi", "AC", "Art Decor"],
        imageUrl: "https://aistudio.google.com/_/upload/6f40da42-c618-4907-a0fb-845407bd4908/attachment/1776420066.818787000/blobstore/prod/makersuite/spanner_managed/global::000054e2ea70026d:0000015f:2:000054e2ea70026d:0000000000000001::f153417887bc02de:000001efdd2018bc:00064fa50709f11f"
      },
      {
        id: "h2_2",
        ...
        price: 9500,
        capacity: 2,
        description: "Pool view with club lounge benefits.",
        available: true,
        amenities: ["Club Access", "Pool View", "WiFi"],
        imageUrl: "https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&q=80&w=800"
      },
      {
        id: "h2_3",
        type: "Le Méridien Suite",
        price: 21000,
        capacity: 4,
        description: "Premium suite with a deep soaking tub.",
        available: true,
        amenities: ["Soaking Tub", "Butler Service", "VIP"],
  ...
  },
  {
    ...
    imageUrl: "https://aistudio.google.com/_/upload/6f40da42-c618-4907-a0fb-845407bd4908/attachment/1776420066.818787000/blobstore/prod/makersuite/spanner_managed/global::000054e2ea70026d:0000015f:2:000054e2ea70026d:0000000000000001::4f8f98029a7f0a8f:000001efdd2018bc:00064fa50709f11f",
    ...
    rooms: [
      {
        ...
        price: 4500,
        capacity: 2,
        description: "Comfortable room for business or leisure.",
        available: true,
      ...
      },
      {
        ...
        price: 6200,
        capacity: 2,
        description: "Modern decor with extra desk space.",
        available: true,
        amenities: ["WiFi", "Mini Bar", "Coffee"],
      ...
      },
      {
        ...
        price: 9800,
        capacity: 4,
        description: "Dedicated kids corner and large beds.",
        available: true,
        amenities: ["Kids Corner", "WiFi", "Large Bed"],
        imageUrl: "https://images.unsplash.com/photo-1566115327231-6111483a67fb?auto=format&fit=crop&q=80&w=800"
      }
    ]
  },
  {
    ...
    rooms: [
      {
        ...
        price: 4000,
        capacity: 2,
        description: "Modern room near the airport.",
        available: true,
        amenities: ["WiFi", "Pool View", "AC"],
        imageUrl: "https://images.unsplash.com/photo-1611892440504-42a792e24d32?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
      },
      {
        id: "h4_2",
        ...
        price: 9500,
        capacity: 3,
        description: "Separate meeting space and parlor.",
        available: true,
        amenities: ["Meeting Space", "Parlor", "WiFi"],
    ...
    rooms: [
      {
        ...
        price: 2800,
        capacity: 2,
        description: "Budget stay with all essentials.",
        available: true,
      ...
      },
      {
        ...
        price: 4900,
        capacity: 4,
        description: "Cost-effective for small families.",
        available: true,
        amenities: ["WiFi", "AC", "Sofa Bed"],
    ...
    rooms: [
      {
        ...
        price: 1800,
        capacity: 2,
        description: "Simple and clean budget room.",
        available: true,
      ...
      {
        id: "h6_2",
        type: "Mahogany (Premium Family)",
        price: 3800,
        capacity: 4,
        description: "Largest rooms for groups of four.",
        available: true,
        amenities: ["WiFi", "Breakfast", "AC", "Water"],
        imageUrl: "https://images.unsplash.com/photo-1576675784432-994941412b3d?auto=format&fit=crop&q=80&w=800"
      }
    ]
  }
];
